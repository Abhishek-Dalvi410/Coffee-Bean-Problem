...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CB}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANTS} X ,\, Y ,\, Z}%
\@x{ {\ASSUME} \.{\land} X\@s{0.35} \.{\in} 0 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} Y \.{\in} 0 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} Z\@s{1.78} \.{\in} 0 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} X \.{+} Y \.{+} Z \.{>} 0}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} CB {\p@lbrace}}%
 \@x{\@s{16.4} {\p@variable} r \.{=} X ,\, g \.{=} Y ,\, b \.{=} Z
 {\p@semicolon}}%
 \@x{\@s{32.8} {\p@lbrace} S\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{59.58} {\p@lbrace} {\p@either}}%
\@x{\@s{81.46} {\p@lbrace} {\p@await}\@s{4.1} ( r \.{>} 1 ) {\p@semicolon}}%
\@x{\@s{103.34} r \.{:=} r \.{-} 2 {\p@semicolon}}%
\@x{\@s{91.04} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{69.16} {\p@or}}%
\@x{\@s{81.46} {\p@lbrace} {\p@await} ( g \.{>} 1 ) {\p@semicolon}}%
\@x{\@s{103.34} g \.{:=} g \.{-} 2 {\p@semicolon}}%
\@x{\@s{103.34} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{69.16} {\p@or}}%
\@x{\@s{81.46} {\p@lbrace} {\p@await} ( b \.{>} 1 ) {\p@semicolon}}%
\@x{\@s{103.34} b \.{:=} b \.{-} 2 {\p@semicolon}}%
\@x{\@s{103.34} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{69.16} {\p@or}}%
 \@x{\@s{81.46} {\p@lbrace} {\p@await} ( r \.{>} 0 \.{\land} g \.{>} 0 )
 {\p@semicolon}}%
 \@x{\@s{103.34} r \.{:=} r \.{-} 1 {\p@semicolon} g \.{:=} g \.{-} 1
 {\p@semicolon} b \.{:=} b \.{+} 1}%
\@x{\@s{103.34} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{69.16} {\p@or}}%
 \@x{\@s{81.46} {\p@lbrace} {\p@await} ( g \.{>} 0 \.{\land} b \.{>} 0 )
 {\p@semicolon}}%
 \@x{\@s{103.34} g \.{:=} g \.{-} 1 {\p@semicolon} b \.{:=} b \.{-} 1
 {\p@semicolon} r \.{:=} r \.{+} 1}%
\@x{\@s{103.34} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{69.16} {\p@or}}%
 \@x{\@s{81.46} {\p@lbrace} {\p@await} ( b \.{>} 0 \.{\land} r \.{>} 0 )
 {\p@semicolon}}%
 \@x{\@s{103.34} b \.{:=} b \.{-} 1 {\p@semicolon} r \.{:=} r \.{-} 1
 {\p@semicolon} g \.{:=} g \.{+} 1}%
\@x{\@s{103.34} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{59.58} {\p@rbrace}}%
\@x{\@s{32.8} {\p@rbrace}}%
...
\@y{\@s{0}%
 ...
 PCal-4b438aebbd77830f73a3c8dc8ac321c0
}%
\@xx{}%
\@x{ {\VARIABLES} r ,\, g ,\, b}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{39.83} \.{\land} r\@s{0.19} \.{=} X}%
\@x{\@s{39.83} \.{\land} g \.{=} Y}%
\@x{\@s{39.83} \.{\land} b\@s{0.25} \.{=} Z}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \.{\land} ( r \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} r \.{'} \.{=} r \.{-} 2}%
\@x{\@s{50.94} \.{\land} {\UNCHANGED} {\langle} g ,\, b {\rangle}}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( g \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g \.{-} 2}%
\@x{\@s{50.94} \.{\land} {\UNCHANGED} {\langle} r ,\, b {\rangle}}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( b \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} b \.{'} \.{=} b \.{-} 2}%
\@x{\@s{50.94} \.{\land} {\UNCHANGED} {\langle} r ,\, g {\rangle}}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( r \.{>} 0 \.{\land} g \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r\@s{0.19} \.{-} 1}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b\@s{0.25} \.{+} 1}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( g \.{>} 0 \.{\land} b \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b\@s{0.25} \.{-} 1}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r\@s{0.19} \.{+} 1}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( b \.{>} 0 \.{\land} r \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b\@s{0.25} \.{-} 1}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r\@s{0.19} \.{-} 1}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g \.{+} 1}%
\@pvspace{8.0pt}%
...
\@y{\@s{0}%
 ...
 (remove to silence divergence warnings): TLA-641e08bc6e7c95f16dc7379efed12d2d
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ invariant \.{\defeq} ( r \.{+} g \.{+} b \.{\geq} 0 )}%
 \@x{ termination \.{\defeq} {\Diamond} ( r \.{+} g \.{+} b \.{\leq} 1
 \.{\land} r \.{+} g \.{+} b \.{\geq} 0 )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{nontermination1} and \ensuremath{nontermination0} are for
 checking the ending at all even constants or all odd constants
}%
\@xx{}%
\@x{ nontermination1 \.{\defeq} {\Diamond} ( r \.{+} g \.{+} b \.{=} 1 )}%
\@x{ nontermination0 \.{\defeq} {\Diamond} ( r \.{+} g \.{+} b \.{=} 0 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{0}{10.0}{}%
 Invariant is \ensuremath{P\.{=}\{r\.{+}g\.{+}b\.{\geq}0\}}
 because:\ensuremath{\.{-}
 invariant \.{\defeq}} (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}); this invaraint
 doesn\mbox{'}t throw an error while model checking
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{stable(P)
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{P\.{\land}G\.{\implies}P(x,\,e)
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{r\.{>}1}) \ensuremath{\.{\implies} r\.{-}2\.{+}g\.{+}b\.{\geq}0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{>}1}) \ensuremath{\.{\implies}
 r\.{+}g\.{+}b\.{\geq}2} (This holds)-1st
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}
}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{g\.{>}1}) \ensuremath{\.{\implies}
 r\.{+}g\.{-}2\.{+}b\.{\geq}0} (This holds;similar to the \ensuremath{1st}
 one)-2nd
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{b\.{>}1}) \ensuremath{\.{\implies}
 r\.{+}g\.{+}b\.{-}2\.{\geq}0} (This holds;similar to the \ensuremath{1st}
 one)-3rd
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{r\.{>}0\.{\land}g\.{>}0}) \ensuremath{\.{\implies}
 r\.{-}1\.{+}g\.{-}1\.{+}b\.{+}1\.{\geq}0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}2}) \ensuremath{\.{\implies}
 r\.{+}g\.{+}b\.{\geq}1} (This holds)-4th
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}
}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{g\.{>}0\.{\land}b\.{>}0}) \ensuremath{\.{\implies}
 r\.{+}1\.{+}g\.{-}1\.{+}b\.{-}1\.{\geq}0} (This holds; similar to
 \ensuremath{4th} one)-5th
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}
}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{+}g\.{+}b\.{\geq}0}) \ensuremath{\.{\land}}
 (\ensuremath{r\.{>}0\.{\land}b\.{>}0}) \ensuremath{\.{\implies}
 r\.{-}1\.{+}g\.{+}1\.{+}b\.{-}1\.{\geq}0} (This holds; similar to
 \ensuremath{4th} one)-6th
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Also from running the models using --fair algorithm;
 \ensuremath{i.e} the algorithm cannot halt if it has at least one enabled
 action:-
\end{cpar}%
\begin{cpar}{0}{T}{T}{20.0}{0}{%
if \ensuremath{X}}%
 ,\ensuremath{Y} and \ensuremath{Z(declared} \ensuremath{constants)}, are all
 \ensuremath{even(includes} \ensuremath{0)} or all odd:
 model terminates at \ensuremath{r\.{+}g\.{+}b\.{=}0} thus comes under
 \ensuremath{r\.{+}g\.{+}b\.{\geq}0
}%
\end{cpar}%
\begin{cpar}{1}{T}{T}{20.0}{0}{%
else}%
:
 model terminates at \ensuremath{r\.{+}g\.{+}b\.{=}1} thus comes under
 \ensuremath{r\.{+}g\.{+}b\.{>}0
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{2}{F}{F}{0}{0}{}%
 Fixed Point is \ensuremath{0\.{\leq}r\.{+}g\.{+}b\.{\leq}1}
 because:\ensuremath{\.{-}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
 \ensuremath{(r\.{>}1)\.{'} \.{\land}} (\ensuremath{g\.{>}1)\.{'} \.{\land}}
 (\ensuremath{b\.{>}1)\.{'} \.{\land}} (\ensuremath{r\.{>}0 \.{\land}
 g\.{>}0)\.{'} \.{\land}} (\ensuremath{g\.{>}0 \.{\land} b\.{>}0)\.{'}
 \.{\land}} (\ensuremath{r\.{>}0 \.{\land} b\.{>}0)\.{'}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{\leq}1}) \ensuremath{\.{\land}} (\ensuremath{g\.{\leq}1})
 \ensuremath{\.{\land}} (\ensuremath{b\.{\leq}1}) \ensuremath{\.{\land}}
 (\ensuremath{r\.{=}0 \.{\lor} g\.{=}0}) \ensuremath{\.{\land}}
 (\ensuremath{g\.{=}0 \.{\lor} b\.{=}0}) \ensuremath{\.{\land}}
 (\ensuremath{r\.{=}0 \.{\lor} b\.{=}0})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{r\.{+}g\.{+}b\.{\leq}1
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
invaraint is given by \ensuremath{r\.{+}g\.{+}b\.{\geq}0
} Thus fixed point is \ensuremath{0\.{\leq}r\.{+}g\.{+}b\.{\leq}1
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{T}{F}{0}{10.0}{}%
Progress:\ensuremath{\.{-}
 termination \.{\defeq} {\Diamond}} (\ensuremath{r\.{+}g\.{+}b\.{\leq}1
 \.{\land} r\.{+}g\.{+}b\.{\geq}0}); this property doesn\mbox{'}t throw an
 error while model checking
 Taking \ensuremath{r\.{+}g\.{+}b\.{=}M}; \ensuremath{M} is bounded below by
 Zero
 To show this is a valid metric function; prove \ensuremath{M} doesn\mbox{'}t
 increase by any action
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
 (\ensuremath{r\.{>}1}) \ensuremath{\.{\rightarrow} r\.{:=}r\.{-}1}
 (\ensuremath{r} decreases hence \ensuremath{M} decreases)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{g\.{>}1}) \ensuremath{\.{\rightarrow} g\.{:=}g\.{-}1}
 (\ensuremath{g} decreases hence \ensuremath{M} decreases)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{b\.{>}1}) \ensuremath{\.{\rightarrow} b\.{:=}b\.{-}1}
 (\ensuremath{b} decreases hence \ensuremath{M} decreases)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{>}0\.{\land}g\.{>}0}) \ensuremath{\.{\rightarrow}
 r\.{:=}r\.{-}1}; \ensuremath{g\.{:=}g\.{-}1}; \ensuremath{b\.{:=}b\.{+}1}
 (net effect is such that \ensuremath{M} decreases by 1)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{g\.{>}0\.{\land}b\.{>}0}) \ensuremath{\.{\rightarrow}
 g\.{:=}g\.{-}1}; \ensuremath{b\.{:=}b\.{-}1}; \ensuremath{r\.{:=}r\.{+}1}
 (net effect is such that \ensuremath{M} decreases by 1)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 (\ensuremath{r\.{>}0\.{\land}b\.{>}0}) \ensuremath{\.{\rightarrow}
 r\.{:=}r\.{-}1}; \ensuremath{b\.{:=}b\.{-}1}; \ensuremath{g\.{:=}g\.{+}1}
 (net effect is such that \ensuremath{M} decreases by 1)
 metric function cannot go below 0
 \ensuremath{M} eventually reaches 1 or 0, so this program terminates
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{2}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Oct} 18
 19:05:35 \ensuremath{EDT} 2020 by \ensuremath{admin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Oct} 17 01:17:14
 \ensuremath{EDT} 2020 by \ensuremath{admin
}%
\end{cpar}%
\end{lcom}%
\end{document}
